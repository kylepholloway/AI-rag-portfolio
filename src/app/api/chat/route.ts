...
export async function POST(req: Request) {
  try {
    ...
    console.log('✅ Embedding Generated:', queryEmbedding.slice(0, 5), '... (truncated)')

    // ✅ Step 2: Query `embeddings` Table for Similar Matches
    console.log('🔍 Querying the embeddings table for relevant context...')
    ...
    // ✅ Step 4: Pass Chat History & Context to OpenAI
